...
var defaultOptions = {
  ...
  workerSrc: {
    ...
    value: '../plugins/pdfjs/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('../plugins/pdfjs/build/pdf.js');
}
...
_createClass(Toolbar, [{
   ...
   value: function setPageNumber(pageNumber, pageLabel) {
     ...
     var lastpageno = $("#pageno").val();
     console.log(pageNumber);
     window.localStorage.setItem("current_page_no", pageNumber);
