                    ...
                    var html =  '' +
                        ...
                        else
                        {
                         ...
                         html +='<li id="del_li'+uniqueID+'" style="text-transform: capitalize;">'+array_file_original[i]+'&nbsp;&nbsp;';
                          ...
                          html +='<a href="/apps/public/documentManagementView?dcno='+array_file_renamed[i]+'&file='+array_file_original[i]+'&id='+res_id+'&page=forms" target="_blank"><i class="fa fa-fw fa-eye" title="View Attached File" ></i></a>';
