...
Annotator.Plugin.Properties = (function(_super) {
    ...
    Properties.prototype.pluginInit = function(options) {
		...
		var comment_created_by = (typeof comment.created_by != 'undefined') ? comment.created_by:{};
		var comment_created_by_name = (typeof comment_created_by.name != 'undefined') ? comment_created_by.name:'user';
                                html += '<li data-id="' + i + '" style="padding:10px 10px 10px 15px">' +
                                    comment.text + '<br/> By ' +
                                    comment_created_by_name + ' at ' +
