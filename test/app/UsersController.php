...
class UsersController extends Controller
{
    ...
    public function emailDuplication(){
        $emialId= Input::get('emialId');

        // Edit
        if(@Input::get('username')):
            $duplicateEntry= Users::where('email', '=', $emialId)->where('username', '!=', Input::get('username'))->get();
        else:
            // Add
            $duplicateEntry= Users::where('email', '=', $emialId )->get();
        endif;
