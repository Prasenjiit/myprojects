...
@section('container')
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{url('/environmentSaveWizard')}}" class="tabs-wrap" id="addaccfrm"> 
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="FileEazy" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" readonly="readonly" />
                    <!-- <span class="help-block error-block invalid-feedback">
                ...
                <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
                    ...
                    <select name="environment" id="environment" onchange='checkEnvironment(this.value);'>
                        ...
                        <option value="development" selected>{{ trans('installer_messages.environment.wizard.form.app_environment_label_developement') }}</option>
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_url" id="app_url" value="http://localhost/fileeazy" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
                ...
                <div class="buttons">
                    <button class="button" type="button" id="showDatabaseSettings">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_name" id="database_name" value="fileeazy" placeholder="{{ trans('installer_messages.environment.wizard.form.db_name_placeholder') }}" />
                ...
                <span style="font-size: 10px;">*Enter the username & password you've entered while the time of phpmyadmin installation</span>
                ...
                <div class="buttons">
                    <button class="button" id="showApplicationSettings" type="button">
            ...
            <div class="tab" id="tab3content">
                ...
                <span id="preload" style="display: none;">Please wait...this will take few minutes.</span>
                <div class="buttons">
                    <button class="button" id="finalsubmit" type="submit">
    ...
    <script>
        ...
        $(function () {        
            ...
            ignore: [],
                    ...
                    {
             var placement = element.data('error_div');         
                      console.log("el ="+element.data("error_div"))
            ...
            invalidHandler: function(form, validator) {
                    ...
                    if (errors) {                    
                        var element_id = validator.errorList[0].element.id;
            var tab_id  = $("#"+element_id).attr("data-tab");
            /*console.log('focus'+tab_id);*/
            ...
            $("#addaccfrm" ).validate({
                ...
                messages: {
                    ...
                    database_hostname: {
                        required: "Please enter database host name"
                    },
                    database_name: {
            ...
            $("#showDatabaseSettings").click(function(){
                if(($('#app_name').valid()==true)){
                    document.getElementById('tab2').checked = true;    
                }
            ...
            $("#showApplicationSettings").click(function(){
                if(($('#database_name').valid()==true) && ($('#database_username').valid()==true) && ($('#database_hostname').valid()==true)){
                    document.getElementById('tab3').checked = true;    
                }
