        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('final') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('environment')}} {{ isActive('environmentWizard')}} {{ isActive('environmentClassic')}}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('permissions') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('requirements') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('welcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{url('/install')}}">
