    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @endif
                  ...
                  @else
                      <li>
                          ...
                          <ul class="treeview-menu">
                            <li class="<?php if(Request::segment(1) == 'departments') echo 'light';?>"><a href="{{url('/departments')}}"><i class="fa fa-angle-right"></i>@if(Session::get('settings_department_name_all')) {{ Session::get('settings_department_name_all') }}@else {{$language['all departments']}} @endif</a></li>
                            @foreach ($deptApp as $key => $val)
                            <li class="<?php if((Request::segment(2) == $val->department_id && Input::get('page') == 'department') || @$_GET['id'] == $val->department_id) echo 'light';?>"><a href="{{url('listview')}}?view=department&id={{$val->department_id}}"><span style="position: relative;left: 7%;"><i style="position: relative;right: 4%;" class="fa fa-angle-right"></i> {{$val->department_name}}</span></a></li>
                            @endforeach
                          </ul>
                  ...
                  @else
                      <li>
                          ...
                          <ul class="treeview-menu">
                            <li class="<?php if(Request::segment(1) == 'stacks') echo 'light';?>"><a href="{{url('/stacks')}}"><a href="{{url('/stacks')}}"><i class="fa fa-angle-right"></i>{{$language['all stacks']}}</a></li>
                            @foreach ($stckApp as $key => $val)
                            <li class="<?php if((Request::segment(2) == $val->stack_id && Input::get('page') == 'stack') || @$_GET['id'] == $val->stack_id ) echo 'light';?>"><a href="{{url('listview')}}?view=stack&id={{$val->stack_id}}"><span style="position: relative;left: 7%;"><i style="position: relative;right: 4%;" class="fa fa-angle-right"></i> {{$val->stack_name}}</span></a></li>
                            @endforeach
                          </ul>
                ...
                @if($menuvalue == 18)
                    <li class="active"><a href="{{url('listview')}}?view=checkout"><i class="fa fa-share-square-o"></i> <span>{{$language['chkout list']}}</span></a></li>
                @else
                    <li><a href="{{url('listview')}}?view=checkout"><i class="fa fa-share-square-o"></i> <span>{{$language['chkout list']}}</span></a></li>
                @endif
                <!-- forms -->              
