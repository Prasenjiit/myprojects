...
<section class="content-header">
	...
	<div class="col-sm-8">
        <span style="float:left;">
            <strong>{{$language['document types']}} </strong>&nbsp;
        </span>
        <span style="float:left;">
            <?php
    ...
    <div class="col-sm-4">
        <!-- <ol class="breadcrumb">
            ...
            <li class="active">{{$language['document types']}}</li>
        </ol> -->
    </div>
...
@endif   
<section class="content content-sty" id="error-msg" style="display: none;"><div class="alert alert-danger alert-sty" id="twm-msg"><strong id="strong-msg">{{$language['error_document_types']}}</strong></div></section>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="form-group">
                <label for="Doc Type" class="col-sm-2 control-label">{{$language['document type']}}: <span class="compulsary">*</span></label>
                <div class="col-sm-8">
                    <input class="form-control" id="name" placeholder="Document Type" required="" data-parsley-required-message="Document type is required" autofocus="autofocus" name="name" type="search" value="" data-parsley-maxlength ="{{$language['max_length']}}" title="{{$language['document type']}} {{$language['length_others']}}">    
                    <div id="dp">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    'title'                  => $language['length_description'],
                    'data-parsley-maxlength'   => $language['max_length_description']
                    )
                    ) 
                    !!}
            ...
            <div class="col-sm-2"></div><div style="color:#777;">{{$language['doc_type_drag_msg']}}</div> 
            <div class="form-group">
                <div class="col-sm-2"></div>
                <!-- <div class="col-sm-1"></div> -->
                <div class="col-sm-3">
                    {!! Form::label($language['index field'], '', array('class'=> 'control-label'))!!}
                </div>
                <div class="col-sm-3">
                    {!! Form::label($language['field type'], '', array('class'=> 'control-label'))!!}
                </div>
                 <div class="col-sm-1">
                    {!! Form::label($language['mandatory'], '', array('class'=> 'control-label'))!!}
                </div>
                <div class="col-sm-1">
        ...
        <div class="form-group">
            ...
            <!-- <button type="button" onclick="myFunction()">Try it</button> -->
                ...
                {!!Form::button($language['add index'],array('class'=>'btn btn-primary','id'=>'addButton','value'=>'addButton'))!!}
            </div>
        </div><!-- /.col -->
        {!! Form::close() !!}
    </div>
...
$('#documentTypeAddForm').on('click','input[type="button"]',function(){
  ...
  if($(this).attr('identity')=='picadd')
  {
    ...
    if(text.length>50)
    {
      swal("{{$language['option_length_must_be']}}");
      return false;
    }
    if(text.length==0)
    {
      swal("{{$language['please_fill_the_text']}}");
      return false;
    }
  ...
  if($(this).attr('identity')=='picdelete')
  {
    if( $("#List"+count).has('option').length == 0 ) {
      swal("{{$language['select_box_is_empty']}}");
      return false;
    }
    else
    {
  ...
  // }else{
      if(txtname){
          ...
          swal({
           ...
           swal({
              title: "{{$language['confirm_delete_single']}}this column?",
              text: "{{$language['Swal_not_revert']}}",
              type: "{{$language['Swal_warning']}}",
              showCancelButton: true
            }).then(function (result) {
        ...
        $.ajax({
            ...
            success:function(result){
                if(result){
                    ...
                    swal({
                        title: "{{$language['confirm_delete_single']}}'" + docGroup + "' ?",
                        text: "{{$language['Swal_not_revert']}}",
                        type: "{{$language['Swal_warning']}}",
                        showCancelButton: true
                      }).then(function (result) {
