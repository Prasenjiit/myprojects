            ...
            <section class="content">
                <div class="row">
                    ...
                    <!--end option to set default -->
                        <h5 id="uploadFile" class="path_text">{{trans('documents.current path')}} : 
            ...
            <div id="checkout-list" style="display:none"> 
                ...
                @endif
                    ...
                    <div class="col-md-3" id='list-div'>
                        ...
                        <p id="num-of-docs">{{@$countdocs}}{{trans('documents.num_docs')}}</p>
                        </div></h5>
                        <!-- Profile Image -->
...
<script type="text/javascript">
var page = "@php echo (isset($page))?$page:1; @endphp";
...
$("#tree-container").on('changed.jstree', function (e, data) {
    ...
    function loadFile(){
        ...
        if(path)
        {
            ...
            {   
                ...
                $("#pdfrender").html('<a href="{{ url('documentManagementView') }}'+"?dcno="+docid+"&id="+tmpid+"&page=document"+'"><button style="margin-bottom:5px;" class="btn btn-primary">Open</button></a>'+addDocument2+'<br/><div class="resizable"><iframe src="https://sharecad.org/cadframe/load?url={{config('app.doc_url') }}'+doc_file_name+'" id="ifrm1" width="auto" height="auto;" class="resizewrapperiframe"></iframe></div>');
            ...
            else
            {
                ...
                $("#pdfrender").html('<a href="{{ url('documentManagementView') }}'+"?dcno="+docid+"&id="+tmpid+"&page=document"+'"><button style="margin-bottom:5px;" class="btn btn-primary">Open</button></a>'+addDocument3+'<br/><iframe src="webviewer?file={{ config('app.doc_url') }}'+path+'&dcno='+docno+'#toolbar=0" id="ifrm1" width="auto" height="auto;" class="resizewrapperiframe"></iframe>');
                $("#tpchkout").html('<a href="{{ url('checkoutDocument') }}'+"?id="+docid+"&view=grid"+'" title="Check Out"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-edit fa-stack-1x fa-inverse"></i><div style="font-size:12px; padding-left:8px; color:#FFFFFF; width:100px; padding-top:25px;">Check Out</div></a>');
            } 
           } 
        }
    ...
    function viewfile(id,dcno,dcname,doc_file_name,exprstatus,toplabel){
        ...
        if(ext=='tiff'||ext=='tif'||ext=='TIFF'||ext=='TIF'){   
          ...
          $("#pdfrender").html('<a href="{{ url('documentManagementView') }}'+"?dcno="+url+"&id="+id+"&page=document"+'"><button style="margin-bottom:5px;" class="btn btn-primary">Open</button></a>'+addDocument2+'<br/><div class="resizable"><iframe src="https://sharecad.org/cadframe/load?url={{config('app.doc_url') }}'+doc_file_name+'" width="auto" id="ifrm1" height="auto;" class="resizewrapperiframe"></iframe></div>'); 
        }
        else if(ext=='gif'||ext=='jpg'||ext=='jpeg'||ext=='png'){ 
            if(user_permission){
                var addDocument3 = '<a href="{{ url('documentAdd') }}"><button style="margin-bottom:5px;" class="btn btn-primary pull-right">Add Document <i class="fa fa-plus"></i></button></a>';
