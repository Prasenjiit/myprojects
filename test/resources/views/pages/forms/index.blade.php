          ...
          <div class="box box-info">
            ...
            <p style="font-size:12px; color:#999;">{{$language['form_help3']}}</p>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <select name="activity_id" id="activity_id" class="form-control activity_id">
                            <option value="0">{{trans('forms.select_activity')}}</option>
              ...
              <div class="box-header with-border">
                ...
                <p style="font-size:12px; color:#999;">{{trans('forms.form_note')}}</p>
              </div>
...
{!! Html::script('plugins/simple-jquery-form-builder/js/sjfb-builder.js') !!}
<script>
