   ...
   <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">            
                <!-- form start -->
                {!! Form::open(array('url'=> array('stackSave','0'), 'method'=> 'post', 'class'=> 'form-horizontal', 'name'=> 'deptAddForm', 'id'=> 'deptAddForm','data-parsley-validate'=> '')) !!}            
                    <div class="form-group">
                        <label for="Stacks Name" class="col-sm-3 control-label">{{trans('language.stacks')}}<span class="compulsary">*</span></label>
                        <div class="col-sm-8">
                            <input class="form-control" id="name" placeholder="Stack" required="" data-parsley-required-message="Stack is required" autofocus="autofocus" name="name" type="search" value="" data-parsley-maxlength ="{{trans('language.max_length')}}" title="{{trans('language.stacks')}} {{trans('language.length_others')}}">    
                            <div id="dp">
