...
<section class="content" id="shw">
  <section class="content-header">
      <div class="row">
          <strong>
              <?php echo e($language['users']); ?>

              <small>- Edit User: <?php echo e($userData->username); ?></small>
          </strong>
          <a href="<?php echo e(url('users')); ?>" class="btn btn-primary">Back</a>
      </div>
  </section>

  <?php if(Session::get('flash_message_wanning')): ?>
      <section class="content content-sty" id="spl-wrn">     
        <div class="alert alert-sty <?php echo e(Session::get('alert-class', 'alert-info')); ?> "><?php echo e(Session::get('flash_message_wanning')); ?></div>        
      </section>
  <?php endif; ?>
  <?php if(Session::get('data')): ?>
  <section class="content content-sty" id="spl-wrn">        
      <div class="alert alert-sty alert-success "><?php echo e(Session::get('data')); ?></div>        
  </section>
  <?php endif; ?>
  <!--Flash message-->
...
<!--Edit Own profile-->
<?php if($logged_in_userId == $userData->id): ?>
<!-- Main content Without Notification Left And Right-->
<!-- Main content Left And Right-->
<section class="content">
<?php if(stristr($user_permission,'view')): ?>
          <?php echo Form::open(array('url'=> array('userSave',$userData->id), 'method'=> 'post', 'class'=> 'form-horizontal dms_form', 'name'=> 'userEditForm', 'id'=> 'userEditForm','data-parsley-validate'=> '')); ?> 
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo e(trans('language.edit_user')); ?></h3> 
                </div><!-- /.box-header -->
                <!--Checking view permission-->
                    ...
                    <div class="modal-body">    
                        ...
                        <div class="form-group">
                                <label for="Full Name" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.full name')); ?>:<span class="compulsary">*</span></label>
                                <div class="col-sm-10">
                                    <?php echo Form:: text('name',$userData->user_full_name, 
                                        array( 
                                            'class'=> 'form-control', 
                                            'id'=> 'name', 
                            ...
                            <div class="form-group">
                                <label for="Email" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.email_id')); ?>: <span class="compulsary">*</span></label>
                                <div class="col-sm-10">
                                  <?php echo Form:: 
                                          text(
                                  ...
                                  <span class="dms_error"><?php echo e($errors->first('email')); ?></span>
                                  <span class="error-msg" id="show-err-msg"></span>
                              </div>
                            </div>
                            <div class="form-group">
                                <label for="Sign In Name" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.sign in name')); ?>: <span class="compulsary">*</span></label>
                                <div class="col-sm-10">
                                  <?php echo Form:: 
                                  text(
                                    ...
                                    <option value=""><?php echo e(trans('language.select_user')); ?></option>
                                       <?php
                                        foreach ($users as $key => $user) {
                                            ?>
                                            <option value="<?php echo $user->id; ?>" <?php if($user->id==$userData->delegate_user) { echo 'selected'; } ?>><?php echo ucfirst(@$user->user_full_name);?> -<?php echo e(@$user->user_role); ?><?php if(@$user->departments[0]->department_name != ""): ?>- <?php echo e(ucfirst(@$user->departments[0]->department_name)); ?> <?php endif; ?></option>
                                            <?php
                                        }
                                        ?> 
                                  </select>
                        ...
                        <?php if(isset($userData->delegate_user)) { echo "required='required;'"; } ?>>
                           ...
                           <!-- Change password-->
                            <?php if($logged_in_userId == $userData->id or $adminUserRole == 1): ?>
                              <div class="form-group">
                                  <div class="col-sm-12"></div>
                                  <div class="col-sm-10">
                                    <?php echo Form::checkbox('pwd_edit',1, false, ['id'=> 'pwd_edit']); ?> Edit password
                                </div>
                              </div>
                            <?php endif; ?>
                            ...
                            <div id="edpwd" style="display: none;">
                              ...
                              <?php if($logged_in_userId == $userData->id): ?>
                                <div class="form-group">
                                    <label for="<?php echo e(trans('language.curpassword')); ?>" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.curpassword')); ?>: <span class="compulsary">*</span></label>
                                    <div class="col-sm-10">
                              ...
                              <div class="form-group">
                                  <label for="Password" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.password')); ?>: <span class="compulsary">*</span></label>
                                  <div class="col-sm-10">
                                      <?php echo Form:: 
                                          password('password', 
                                              array( 
                                  ...
                                  <!--Complexity message-->
                                  <span class="formInfo"><a href="<?php echo e(url('getsecuritySettings')); ?>?id=<?php echo $userData->id;?>" class="jTip" id="one" name="Password must follow these rules:">?</a></span>
                              </div>
                            ...
                            <div id="unlck">
                                ...
                                if(($userData->user_lock_status == Session::get('user_lock_status_Locked')) && ($userData->user_role == Session::get('user_role_super_admin'))){ ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <a href="javascript:void(0);" onclick="unlock(<?php echo e($userData->id); ?>,'<?php echo e($userData->username); ?>')"><li class="fa fa-lock" ></li> Unlock Account</a>            
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>   
                            ...
                            if($userData->user_role == Session::get('user_role_group_admin') or $userData->user_role == Session::get('user_role_regular_user') ) {
                              ?>
                                ...
                                <!--Department Admin-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php if(Auth::user()->user_role == Session::get('user_role_super_admin')): ?>
                                                <div class="col-sm-4">
                                                    <input type="radio" name="user_type" id="super_admin" class="rd"  value="1" <?php if($userData->user_role == Session::get('user_role_super_admin')) echo 'checked'; ?> ><?php echo e(trans('language.super admin')); ?>

                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="radio" name="user_type" id="group_admin" class="rd"  value="2" <?php if($userData->user_role == Session::get('user_role_group_admin')) echo 'checked'; ?> ><?php echo e(trans('language.group admin')); ?>

                                                </div>
                                                <div class="col-sm-4">
                                                    <input type="radio" name="user_type" id="regular_user" class="rd"  value="3" <?php if($userData->user_role == Session::get('user_role_regular_user')) echo 'checked'; ?> ><?php echo e(trans('language.regular user')); ?>
                                    ...
                                    <div id="spl_div_edi">
                                        <div class="form-group">
                                            <label for="Departments" class="col-sm-12 control-label notif_label"><?php if(Session::get('settings_department_name')): ?> <?php echo e(Session::get('settings_department_name')); ?><?php else: ?> <?php echo e(trans('language.departments')); ?> <?php endif; ?>: <span class="compulsary">*</span></label>
                                            ...
                                            <?php
                                              ...
                                              if($stringSearch > 0){
                                                ...
                                                foreach ($departments as $key => $val) { ?> 
                                                    <input type="checkbox" required data-parsley-required-message ="<?php if(Session::get('settings_department_name')): ?> <?php echo e(Session::get('settings_department_name')); ?><?php else: ?> <?php echo e(trans('language.department')); ?> <?php endif; ?> <?php echo e(trans('language.is_required')); ?>"  name="document_group[]" data-parsley-mincheck= '1'  value="<?php echo $val->department_id; ?>" <?php if(in_array($val->department_id,$str)) echo 'checked';?> > <?php echo $val->department_name; ?>
                                                <?php } 

                                              } else {

                                                  foreach ($departments as $key => $val) { ?>
                                                    <input type="checkbox" required required data-parsley-required-message ="<?php if(Session::get('settings_department_name')): ?> <?php echo e(Session::get('settings_department_name')); ?><?php else: ?> <?php echo e(trans('language.department')); ?> <?php endif; ?> <?php echo e(trans('language.is_required')); ?>" name="document_group[]" data-parsley-mincheck= '1'  value="<?php echo $val->department_id; ?>" <?php if($val->department_id == $userData->department_id) echo 'checked'; ?>> <?php echo $val->department_name; ?> &nbsp; 
                                                    <?php
                                                  }
                                  ...
                                  <input type="hidden" value="<?php echo e(Request::segment(2)); ?>" id="userId">
                                   <input type="hidden" value="<?php echo e($userData->user_role); ?>" id="usrRol">
                                    <div class="form-group">
                                        <label for="<?php echo e(trans('language.privileges')); ?>" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.privileges')); ?> : <span class="compulsary">*</span></label>
                                        <div class="col-sm-10">
                                        <?php
                                        if($userData->user_role == Session::get('user_role_group_admin')) {
                                        ?> 
                                            <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="user_permission" class="usr_permission" id="eadd" data-parsley-mincheck= '1'  value="add" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?> > Add &nbsp;&nbsp;
                                            <input type="checkbox" name="user_permission[]" class="usr_permission" id="eedit" value="edit" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?>> <?php echo e(trans('language.edit')); ?> &nbsp;&nbsp;
                                            ...
                                            {
                                          ?>
                                              <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="user_permission[]" class="usr_permission" id="eadd" data-parsley-mincheck="1" value="add" <?php if(in_array('add', $usrPrm)) echo 'checked'; ?>> Add&nbsp;&nbsp;
                                              <input type="checkbox" name="user_permission[]" class="usr_permission" id="eedit" value="edit" <?php if(in_array('edit', $usrPrm)) echo 'checked'; ?> > <?php echo e(trans('language.edit')); ?>&nbsp;&nbsp;
                                              ...
                                              <input type="checkbox" name="user_permission[]" class="usr_permission" id="echeckout" value="checkout" <?php if(in_array('checkout', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.checkinout')); ?>&nbsp;&nbsp;
                                              <input type="checkbox" name="user_permission[]" class="usr_permission" id="eimport" value="import" <?php if(in_array('import', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.import')); ?>&nbsp;&nbsp;
                                              <input type="checkbox" name="user_permission[]" class="usr_permission" id="eexport" value="export" <?php if(in_array('export', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.export')); ?>

                                              &nbsp;&nbsp;
                                              <input type="checkbox" name="user_permission[]" class="usr_permission" id="eworkflow" value="workflow" <?php if(in_array('workflow', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.workflow')); ?>

                                              &nbsp;&nbsp;
                                              <input type="checkbox" name="user_permission[]" class="usr_permission" id="edecrypt" value="decrypt" <?php if(in_array('decrypt', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.decrypt')); ?>
                                  ...
                                  <div class="form-group">
                                        <label for="<?php echo e(trans('language.form_privileges')); ?>" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.form_privileges')); ?> : <span class="compulsary">*</span></label>
                                        <div class="col-sm-10">
                                        <?php
                                        if($userData->user_role == Session::get('user_role_group_admin')) {
                                        ?> 
                                        <div class="col-sm-4">
                                            <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="privileges_frm[]" class="frm_privileges" id="eaddFrm" data-parsley-mincheck= '1'  value="add" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?> > Add &nbsp;&nbsp;
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">                                            
                                          ...
                                          ?>
                                          <div class="col-sm-4">
                                              <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="privileges_frm[]" class="frm_privileges" id="eaddFrm" data-parsley-mincheck="1" value="add" <?php if(in_array('add', $usrPrmFrm)) echo 'checked'; ?>> Add&nbsp;&nbsp;
                                            </div>
                                            <div class="col-sm-4">
                                              <input type="checkbox" name="privileges_frm[]" class="frm_privileges" id="eeditFrm" value="edit" <?php if(in_array('edit', $usrPrmFrm)) echo 'checked'; ?> > <?php echo e(trans('language.edit')); ?>&nbsp;&nbsp;
                                            </div>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                              <input type="checkbox" name="privileges_frm[]" class="frm_privileges" id="eexportFrm" value="export" <?php if(in_array('export', $usrPrmFrm)) echo 'checked'; ?>> <?php echo e(trans('language.export')); ?>
                                  ...
                                  <div class="form-group">
                                        <label for="<?php echo e(trans('language.workflow_privileges')); ?>" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.workflow_privileges')); ?> : <span class="compulsary">*</span></label>
                                        <div class="col-sm-10">
                                        <?php
                                        if($userData->user_role == Session::get('user_role_group_admin')) {
                                        ?> 
                                            <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="privileges_wf[]" class="wf_previlages" id="eaddWrkFlw" data-parsley-mincheck= '1'  value="add" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?> > Add &nbsp;&nbsp;
                                            ...
                                            {
                                          ?>
                                              <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="privileges_wf[]" class="wf_previlages" id="eaddWrkFlw" data-parsley-mincheck="1" value="add" <?php if(in_array('add', $usrPrmWrkflw)) echo 'checked'; ?>> Add&nbsp;&nbsp;
                                              <input type="checkbox" name="privileges_wf[]" class="wf_previlages" id="eeditWrkFlw" value="edit" <?php if(in_array('edit', $usrPrmWrkflw)) echo 'checked'; ?> > <?php echo e(trans('language.edit')); ?>&nbsp;&nbsp;
                                  ...
                                  <?php if($userData->user_login_expiry): ?>
                                    <div class="form-group">
                                      <label for="Sign In Expiry Date" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.expiry_date')); ?>: </label>
                                      <div class="col-sm-10">
                                          <div >
                                            <?php if($userData->user_login_expiry == '0000-00-00'): ?>
                                              No Expire
                                            <?php else: ?>
                                              <?php echo e($userData->user_login_expiry); ?>
                              ...
                              <!--Regular User-->
                                  ...
                                  <input type="hidden" name="user_type" value="3">
                                        ...
                                        <div class="col-sm-10">
                                              <input type="radio"  disabled id="regular_user" class="rd"  value="3" <?php if($userData->user_role == Session::get('user_role_regular_user')) echo 'checked'; ?> ><?php echo e(trans('language.regular user')); ?>
                                   ...
                                   <div id="spl_div_edi">
                                      <div class="form-group">
                                          <label for="Departments" class="col-sm-12 control-label notif_label"><?php if(Session::get('settings_department_name')): ?> <?php echo e(Session::get('settings_department_name')); ?><?php else: ?> <?php echo e(trans('language.department')); ?> <?php endif; ?>: </label>
                                  ...
                                  <div class="form-group">
                                        <label for="<?php echo e(trans('language.privileges')); ?>" class="col-sm-12 control-label notif_label"><?php echo e(trans('language.privileges')); ?> :</label>
                                        <div class="col-sm-10">
                                        <?php
                                            $usrPrm= explode(",",$userData->user_permission);
                                            $cnt= count($usrPrm);
                                          ...
                                          ?>
                                              ...
                                              <input type="checkbox" disabled   <?php if(in_array('edit', $usrPrm)) echo 'checked'; ?> > <?php echo e(trans('language.edit')); ?>&nbsp;&nbsp;
                                              ...
                                              <input type="checkbox" disabled  <?php if(in_array('checkout', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.checkinout')); ?>&nbsp;&nbsp;
                                              <input type="checkbox" disabled  <?php if(in_array('import', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.import')); ?>&nbsp;&nbsp;
                                              <input type="checkbox" disabled  <?php if(in_array('export', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.export')); ?>&nbsp;&nbsp;
                                              <input type="checkbox" disabled  <?php if(in_array('workflow', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.workflow')); ?>              
                                          <?php
                                          }
                                      ?>
                                      </div>
...
<div class="col-md-12">
            <div class="box box-primary">
                ...
                <?php
                  ...
                  <?php // echo'<pre>'; print_r(Session::all());echo'</pre>';?>
                            <div class="form-group">
                                <label for="<?php echo e(trans('language.privileges')); ?>" class="col-sm-12 control-label"><?php echo e(Lang::get('language.email_notifications')); ?>: <span class="compulsary">*</span></label>
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-12">
             ...
             <?php else: ?> 
                      <div class="alert alert-danger alert-sty"><?php echo e(trans('language.dont_hav_permission')); ?></div>
                <?php endif; ?>
        </div> 
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo e(trans('language.notification')); ?></h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <ul class="todo-list">
                      ...
                      <?php if(Session::get('notification_expire_date')): ?>
                        ...
                        foreach(Session::get('notification_expire_date') as $val){
                          ?>
                            <li><span class="fa fa-star text-yellow"></span><a href="<?php echo e(url('/listview?view=list&notification=1')); ?>"><span class="text"><?php echo $val;?></span></a></li>
                          <?php 
                        }
                        ?>
                        <?php else: ?>
                          <?php echo e(trans('language.no_notification')); ?>
        ...
        <?php echo Form:: hidden('user_role', $userData->user_role ); ?> 
                            <div class="form-group">
                                <label class="col-sm-12 control-label notif_label"></label>
                                <div class="col-sm-10 s-btn">
                                    <?php echo Form::submit('Save', array('class' => 'btn btn-primary sav_btn')); ?> &nbsp;&nbsp;
                                    <a href="<?php echo e(URL::route('users')); ?>" class = "btn btn-primary btn-danger">Cancel</a>
                                </div>
                            </div><!-- /.col -->
              <?php echo Form::close(); ?>    
        </div>
...
<div class="modal-body"> 
    ...
    <?php echo Form::open(array('url'=> array('userSave',$userData->id), 'method'=> 'post', 'class'=> 'form-horizontal dms_form', 'name'=> 'userEditForm', 'id'=> 'userEditForm','data-parsley-validate'=> '')); ?>            
        <div class="form-group">
            <label for="Full Name" class="col-sm-2 control-label"><?php echo e(trans('language.full name')); ?>:<span class="compulsary">*</span></label>
            <div class="col-sm-8">
                <?php echo Form:: 
        ...
        <div class="form-group">
            <label for="Email" class="col-sm-2 control-label"><?php echo e(trans('language.email_id')); ?>: <span class="compulsary">*</span></label>
            <div class="col-sm-8">
                <?php echo Form:: 
                    text(
                        'email',$userData->email, 
        ...
        <div class="form-group">
            <label for="Sign In Name" class="col-sm-2 control-label"><?php echo e(trans('language.sign in name')); ?>: <span class="compulsary">*</span></label>
            <div class="col-sm-8">
                <?php echo Form:: 
                    text(
                        'username',$userData->username, 
        ...
        <div id="edpwd" style="display: none;">
            <?php if($logged_in_userId == $userData->id): ?>
                <div class="form-group">
                    <label for="<?php echo e(trans('language.curpassword')); ?>" class="col-sm-2 control-label"><?php echo e(trans('language.curpassword')); ?>: <span class="compulsary">*</span></label>
                    <div class="col-sm-8">
                        <?php echo Form::password('current_password',
                        ['placeholder' => trans('language.curpassword'),
                        'class' => 'form-control',
            ...
            <div class="form-group">
                <label for="Password" class="col-sm-2 control-label"><?php echo e(trans('language.password')); ?>: <span class="compulsary">*</span></label>
                <div class="col-sm-8">
                    <?php echo Form:: 
                    password('password', 
                        array( 
        ...
        <?php if(( Auth::user()->user_role == Session::get('user_role_super_admin') ) || ( Auth::user()->user_role == Session::get('user_role_group_admin') ) ): ?>
            <div class="form-group">
                <label for="User Type" class="col-sm-2 control-label"><?php echo e(trans('language.user_status')); ?> <span class="compulsary">*</span></label>
                <div class="col-sm-8">
                    <div class="col-sm-4 nopadinglft">
                        <input type="radio" name="user_status" id="status_active" value="1" <?php if($userData->user_status == Session::get('user_status_Active')) echo 'checked'; ?>> <?php echo e(trans('language.active')); ?>

                    </div>
                    <div class="col-sm-4">  
                        <input type="radio" name="user_status" id="status_inactive" value="0" <?php if($userData->user_status == Session::get('user_status_Inactive')) echo 'checked'; ?>> <?php echo e(trans('language.inactive')); ?>
        ...
        if($userData->user_role == Session::get('user_role_group_admin') or $userData->user_role == Session::get('user_role_regular_user') or $userData->user_role == Session::get('user_role_private_user') ) { ?>
            ...
            <?php if(Auth::user()->user_role != Session::get('user_role_regular_user') || Auth::user()->user_role != Session::get('user_role_private_user')): ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <?php if(Auth::user()->user_role == Session::get('user_role_super_admin')): ?>
                            ...
                            <div class="col-sm-4 nopadinglft">
                                <input type="radio" name="user_type" id="private_user"  class="rd"  value="4" <?php if($userData->user_role == Session::get('user_role_private_user')) echo 'checked'; ?> > <?php echo e(trans('language.private_user')); ?>

                            </div>
                            <div class="col-sm-4">
                                <input type="radio" name="user_type" id="viewonly_user" class="rd"  value="3" <?php if($userData->user_view_only == '1') echo 'checked'; ?> > <?php echo e(trans('language.viewonly_user')); ?> 
                        </div>
                        ...
                        <?php elseif(Auth::user()->user_role == Session::get('user_role_group_admin')): ?> 
                            ...
                            <?php if(Auth::user()->user_role != $userData->user_role): ?>
                                <div class="col-sm-4">
                                    <input type="radio" name="user_type" id="regular_user" class="rd"  value="3" <?php if($userData->user_role == Session::get('user_role_regular_user')) echo 'checked'; ?> > <?php echo e(trans('language.regular user')); ?> 
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4 nopadinglft">
                                    <input type="radio" name="user_type" id="viewonly_user"  class="rd"  value="3" <?php if($userData->user_view_only == '0') echo 'checked'; ?> > <?php echo e(trans('language.viewonly_user')); ?>
                ...
                <div id="spl_div_edi">
                    <div class="form-group">
                        <label for="Departments" class="col-sm-2 control-label"><?php if(Session::get('settings_department_name')): ?> <?php echo e(Session::get('settings_department_name')); ?><?php else: ?> <?php echo e(trans('language.department')); ?> <?php endif; ?>: <span class="compulsary">*</span></label>
                ...
                <div class="form-group">
                    <label for="<?php echo e(trans('language.privileges')); ?>" class="col-sm-2 control-label"><?php echo e(trans('language.privileges')); ?> : <span class="compulsary">*</span></label>
                    <div class="col-sm-8">
                        <?php if($userData->user_role == Session::get('user_role_group_admin')) { ?>  
                            <div class="col-sm-4 nopadinglft">
                                <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="user_permission" id="eadd" class="usr_permission" data-parsley-mincheck= '1' class="privilege" value="add" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?> > <?php echo e(trans('language.add')); ?>
                            ...
                            <div class="col-sm-4">
                                <input type="checkbox" name="user_permission[]" class="usr_permission" class="privilege" id="eworkflow" value="workflow" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?>> <?php echo e(trans('language.workflow')); ?> 
                            </div>
                            <div class="col-sm-4">
                                <input type="checkbox" name="user_permission[]" class="usr_permission" class="privilege" id="edecrypt" value="decrypt" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?>> <?php echo e(trans('language.decrypt')); ?> 
                            </div>
                            <div class="col-sm-4 nopadinglft">
                                <input type="checkbox" name="all" id="es_all" value="all" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?>> <?php echo e(trans('language.select_all')); ?>   
                            </div>               
                            <?php
                        } else {
                            $usrPrm= explode(",",$userData->user_permission);
                            ...
                            if($cnt){ ?>  
                                <div class="col-sm-4 nopadinglft">
                                    <input required="" data-parsley-required-message="<?php echo e(trans('language.user_access_privileges_is_required')); ?>" type="checkbox" name="user_permission[]" class="usr_permission" id="eadd" data-parsley-mincheck="1" value="add" <?php if(in_array('add', $usrPrm)) echo 'checked'; ?>> <?php echo e(trans('language.add')); ?>
                                ...
                                <div class="col-sm-4">
                                    <input type="checkbox" name="user_permission[]" class="usr_permission" id="eview" value="view" <?php if(in_array('view', $usrPrm)) echo 'checked'; ?> > <?php echo e(trans('language.view')); ?>

                                </div>
                                <div class="col-sm-4 nopadinglft">
                                    <input type="checkbox" name="user_permission[]" class="usr_permission" id="edelete" value="delete" <?php if(in_array('delete', $usrPrm)) echo 'checked'; ?> > <?php echo e(trans('language.delete')); ?>
                                ...
                                <div class="col-sm-4 nopadinglft">
                                    <input type="checkbox" name="all" id="es_all" value="all" <?php if($cnt == 9) echo 'checked'; ?>> <?php echo e(trans('language.select_all')); ?>
              ...
              <div class="form-group">
                    <label for="<?php echo e(trans('language.privileges')); ?>" class="col-sm-2 control-label"><?php echo e(trans('language.form_privileges')); ?> : </label>
                    <div class="col-sm-8">
                    <?php
                    if($userData->user_role == Session::get('user_role_group_admin')) {
                    ?>  
                    <div class="col-sm-4 nopadinglft">
                        <input required="" data-parsley-required-message="<?php echo e(trans('language.form_access_privileges_is_required')); ?>" type="checkbox" name="privileges_frm[]" class="frm_privileges" id="eaddFrm" data-parsley-mincheck= '1' class="privilege" value="add" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?> > <?php echo e(trans('language.add')); ?> 
                    </div>
                    <div class="col-sm-4">                        
                    ...
                    <div class="col-sm-4">
                      ...
                      ?>  
                      <div class="col-sm-4 nopadinglft">
                          <input type="checkbox" name="privileges_frm[]" class="frm_privileges" id="eaddFrm" data-parsley-mincheck="1" value="add" <?php if(in_array('add', $usrPrmFrm)) echo 'checked'; ?>> <?php echo e(trans('language.add')); ?>
                       ...
                       <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                          <input type="checkbox" name="privileges_frm[]" class="frm_privileges" id="eviewFrm" value="view" <?php if(in_array('view', $usrPrmFrm)) echo 'checked'; ?> > <?php echo e(trans('language.view')); ?>

                        </div>
                        <div class="col-sm-4 nopadinglft">
                          <input type="checkbox" name="privileges_frm[]" class="frm_privileges" id="edeleteFrm" value="delete" <?php if(in_array('delete', $usrPrmFrm)) echo 'checked'; ?> > <?php echo e(trans('language.delete')); ?>
                        ...
                        <div class="col-sm-4">  
                         ...
                         <div class="col-sm-4"> 
                          <input type="checkbox" name="s_all_frm" id="s_all_frm" value="all" <?php if($cnt == 5) echo 'checked'; ?>> <?php echo e(trans('language.select_all')); ?>   
                        </div>               
                      <?php
                      }
                  }
              ...
              <div class="form-group">
                    <label for="<?php echo e(trans('language.privileges')); ?>" class="col-sm-2 control-label"><?php echo e(trans('language.workflow_privileges')); ?> : </label>
                    <div class="col-sm-8">
                    <?php
                    if($userData->user_role == Session::get('user_role_group_admin')) {
                    ?>  
                    <div class="col-sm-4 nopadinglft">
                        <input required="" data-parsley-required-message="<?php echo e(trans('language.wf_access_privileges_is_required')); ?>" type="checkbox" name="privileges_wf[]" id="eaddWrkFlw" class="wf_previlages" data-parsley-mincheck= '1' class="privilege" value="add" <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'checked'; ?>  required <?php if($userData->user_role == Session::get('user_role_super_admin') or $userData->user_role == Session::get('user_role_group_admin') ) echo 'disabled'; ?> > <?php echo e(trans('language.add')); ?> 
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                      ...
                      ?>  
                      <div class="col-sm-4 nopadinglft">
                          <input type="checkbox" name="privileges_wf[]" id="eaddWrkFlw" class="wf_previlages" data-parsley-mincheck="1" value="add" <?php if(in_array('add', $usrPrmWf)) echo 'checked'; ?>> <?php echo e(trans('language.add')); ?>

                        </div>
                        <div class="col-sm-4">
                          <input type="checkbox" name="privileges_wf[]" class="wf_previlages" id="eeditWrkFlw" value="edit" <?php if(in_array('edit', $usrPrmWf)) echo 'checked'; ?> > <?php echo e(trans('language.edit')); ?>

                        </div>
                        <div class="col-sm-4">
                          <input type="checkbox" name="privileges_wf[]" class="wf_previlages" id="eviewWrkFlw" value="view" <?php if(in_array('view', $usrPrmWf)) echo 'checked'; ?> > <?php echo e(trans('language.view')); ?>

                        </div>
                        <div class="col-sm-4 nopadinglft">
                          <input type="checkbox" name="privileges_wf[]" class="wf_previlages" id="edeleteWrkFlw" value="delete" <?php if(in_array('delete', $usrPrmWf)) echo 'checked'; ?> > <?php echo e(trans('language.delete')); ?>

                        </div>
                        <div class="col-sm-4">
                          <input type="checkbox" name="s_all_wf" id="s_all_wf" value="all" <?php if($cnt == 4) echo 'checked'; ?>> <?php echo e(trans('language.select_all')); ?>            
                        </div>
                      <?php
                      }
                  }
              ...
              <div class="form-group">
                                <label for="<?php echo e(trans('language.privileges')); ?>" class="col-sm-2 control-label"><?php echo e(Lang::get('language.email_notifications')); ?>: <span class="compulsary">*</span></label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <label class="control-label">
        ...
        <?php if( (Auth::user()->id != $userData->id) &&  ( (Auth::user()->user_role == Session::get('user_role_super_admin') ) || ( Auth::user()->user_role == Session::get('user_role_group_admin')) ) ): ?>
          ...
          <div class="form-group">
              ...
              <span class="formInfo"><a href="<?php echo e(url('getUserMessages')); ?>?which_message=date_setting_msg" class="jTip" id="three" name="Notice:">?</a></span>
              &nbsp;&nbsp;&nbsp;
               ...
               <select class="form-control report_to" id="report_to"   name="report_to">
                        <option value=""><?php echo e(trans('language.select_user')); ?></option>
                           <?php
                            foreach ($users as $key => $user) {
                                ?>
                                <option value="<?php echo $user->id; ?>" <?php if($user->id==$userData->report_to) { echo 'selected'; } ?>><?php echo ucfirst(@$user->user_full_name);?> -<?php echo e(@$user->user_role); ?><?php if(@$user->departments[0]->department_name != ""): ?>- <?php echo e(ucfirst(@$user->departments[0]->department_name)); ?> <?php endif; ?></option>
                                <?php
                            }
                            ?> 
                        </select>
    ...
    $(document).ready(function(){
      ...
      $("#delegate_user").on('change',function() {
        ...
        if(delegate_user=='') {
          ...
          $.ajax({
                    type:'GET',
                    url:'<?php echo e(URL('getUserAvailable')); ?>',
            ...
            if(id == 'super_admin'){   
              ...
              //Either Regulare user or Private user
                 ...
                 // Get privileges for select
                  $.ajax({
                    type:'GET',
                    url:'<?php echo e(URL('getUserPermission')); ?>',
