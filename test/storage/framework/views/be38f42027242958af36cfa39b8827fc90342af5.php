...
<html>
  <head>
    ...
    <!-- Ionicons -->
    <?php echo Html::style('dist/css/ionicons.min.css'); ?>
    ...
    <?php echo Html::style('plugins/iCheck/square/blue.css'); ?> <?php echo Html::style('css/custom-css.css'); ?>

    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]-->
    <?php echo Html::script('js/html5shiv.min.js'); ?> <?php echo Html::script('js/respond.min.js'); ?>
            ...
            <div class="row">
              <div class="col-xs-12 login_box_offset">
                <div class="login-box-body">
                  ...
                  <?php echo Form:: open(array('url'=>'/login', 'method'=>'post','autocomplete' => 'off')); ?> <?php setcookie("test_cookie", "test"); ?>
                  <div class="form-group has-feedback">
                    ...
                    <?php endif; ?> <?php if(Session::has('flash_message_wanning')): ?>
                    <div class="alert alert-warning alert-dismissible" style="font-size: 12px;"><?php echo e(Session::get('flash_message_wanning')); ?></div>
                    <?php endif; ?> 
                  </div>

                  <?php if($errors->has('username')): ?>
                    <label><?php echo e($errors->first('username')); ?></label>
                <?php endif; ?>
                  <div class="form-group has-feedback">
                    <?php echo Form:: text('username', '', array('class' => 'form-control custom_readonly', 'id'=> 'username', 'placeholder'=> 'Username','autofocus' => 'true','autocomplete'=>'off','readonly'=>'readonly','onfocus'=>"this.removeAttribute('readonly');")); ?>
...
<?php if($errors->has('password')): ?>
                    <label><?php echo e($errors->first('password')); ?></label>
                <?php endif; ?>
                  <div class="form-group has-feedback">
                    <?php echo Form:: password('password', array( 'class'=> 'form-control custom_readonly','id'=> 'password', 'placeholder'=> 'Password','autocomplete'=>'off','readonly'=>'readonly','onfocus'=>"this.removeAttribute('readonly');")); ?>
                  ...
                  <div class="row">
                    <div class="col-xs-8">
                      <a href="<?php echo e(url('password/reset')); ?>">I forgot my password ?</a>
                    </div>
                    <!-- /.col -->
                    <div class="col-xs-4">
                      <?php echo Form::submit('Sign In', array('class' => 'btn login-btn-primary btn-block btn-flat','id'=>'login')); ?>
...
</html><?php /**PATH F:\xampp\htdocs\nspl5.8\resources\views/auth/login.blade.php ENDPATH**/ ?>